    ...
    <div className={styles.cardWrapper}>
      <div className={styles.card}>
        ...
        <p className={styles.description}>
          ...
          Care Taker - RM150.00<br />
          Cleaner - RM100.00 - 2 persons<br />
          If Food Catering done - NO WASHING OF DISHES ALLOWED<br />
          Please confirm 2 weeks before the event <br />
          (Tel: 03-26934709 - En. Zamri/M. Vijaya)<br />
          <br />
          <br />
          <b>Other Facilities</b>
          <br />
          Rental of Dormitory - RM20.00 per bed x 20 beds<br />
          Rental of Rooms with fan - RM50/RM65.00<br />
          Rental of Rooms with air-cond - RM80.00<br />
          <br />
          <br />
        </p>
