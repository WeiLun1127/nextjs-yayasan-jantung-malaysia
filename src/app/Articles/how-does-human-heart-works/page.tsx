  ...
  return (
    <div>
      ...
      <p className={styles.description}>
        This describes the anatomy or structure of the human heart and circulation of blood to the body. The heart is a powerful muscular organ. It consists of 4 chambers &ndash; the right side of the heart separated from the left by a muscular wall &ndash; the septum, and the upper and lower chambers (atria and ventricles) are separated by valves. With each heart contraction, the blood is pumped out from the left ventricle to the whole body to supply oxygen and nutrients to all the tissues of the body.
        <br />
        <br />
        This &lsquo;used&rsquo; or &lsquo;deoxygenated&rsquo; blood then returns to the right side of the heart to the right Atrium and ventricle. From the right ventricle, the deoxygenated blood goes to the lungs where it receives fresh oxygen (re-oxygenated). This then returns to the left side of the heart and the circulation continues.
        <br />
        <br />
      ...
      <div className={`${styles.cardContainer} ${styles.wideCardContainer}`}>
        <div className={`${styles.card} ${styles.wideCard}`}>
          ...
          <p>
            ...
            <br />
            CAD occurs when there is obstruction to the flow of blood in the Coronary arteries due to a build-up of cholesterol plaque in the artery wall. This can result in a 'heart attack'.
          </p>
        </div>
      </div>
      <br />
